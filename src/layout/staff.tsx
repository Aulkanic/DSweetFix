    ...
    <Layout className="h-max min-h-screen">
      ...
      >
        <div className="p-4">
          {!collapsed ? (
            <>
              <p className="font-grand-hotel text-4xl text-black">
                D’ Sweet Fix
              </p>
              <p className="text-black text-lg">BAKING & CONFECTIONERY SHOP</p>
            </>
          ) : (
            <p className="font-grand-hotel text-2xl text-black">D’SF</p>
          )}
        </div>
        <Menu
          theme="dark"
